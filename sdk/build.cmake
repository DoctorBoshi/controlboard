...
if (DEFINED CFG_BUILD_IIC OR DEFINED CFG_BUILD_IIC_SW)
    target_link_libraries(${CMAKE_PROJECT_NAME}
        iic
    )
endif()
...
elseif ($ENV{CFG_PLATFORM} STREQUAL openrtos)
    ...
    if ((DEFINED CFG_CPU_FA626) AND ("${CMAKE_PROJECT_NAME}" STREQUAL "bootloader"))
        ...
        add_custom_command(
            ...
            ARGS
                ...
                -DCFG_BL_SHOW_LOGO=${CFG_BL_SHOW_LOGO}
    ...
    if (DEFINED CFG_UPGRADE_DATA)
        ...
        # partition
        if (DEFINED CFG_NAND_ENABLE AND DEFINED CFG_NAND_PARTITION0_SIZE)
        ...
        if (DEFINED CFG_NAND_ENABLE AND DEFINED CFG_NAND_PARTITION1_SIZE)
        ...
        if (DEFINED CFG_NAND_ENABLE AND DEFINED CFG_NAND_PARTITION2_SIZE)
        ...
        if (DEFINED CFG_NAND_ENABLE AND DEFINED CFG_NAND_PARTITION3_SIZE)
