...
#define ITH_OPENVG_BASE                 0xB0700000
...
// CAP CLOCK
#define ITH_CAP_CLK_REG                 0x0062     // for ccir601/656 capture controller internal operation.
#define ITH_EN_CAPC_RST_BIT             3          // reset ccir601/656 capture. 0: normal operation; 1: reset.
#define ITH_EN_M17CLK_BIT               0          // ccir601/656 capture memory clock. 0: disable; 1: enable.
...
#define ITH_CMDQ_WR_BIT                 3
#define ITH_CMDQ_WR_MASK                (N16_BITS_MSK << ITH_CMDQ_WR_BIT)

#define ITH_CMDQ_RD_REG                 0x000C
#define ITH_CMDQ_RD_BIT                 3
#define ITH_CMDQ_RD_MASK                (N16_BITS_MSK << ITH_CMDQ_RD_BIT)
