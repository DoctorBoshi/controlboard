 ...
 * @param ctrl the controls to enable.
 */
static inline void ithCmdQCtrlEnable(ITHCmdQCtrl ctrl)
{
#if (CFG_CHIP_FAMILY == 9920)
    ithSetRegBitA(ITH_CMDQ_BASE + ITH_CMDQ_CR_REG, ctrl);
#else
 ...
 * @param ctrl the controls to disable.
 */
static inline void ithCmdQCtrlDisable(ITHCmdQCtrl ctrl)
{
#if (CFG_CHIP_FAMILY == 9920)
    ithClearRegBitA(ITH_CMDQ_BASE + ITH_CMDQ_CR_REG, ctrl);
#else
 ...
 */
static inline void ithCmdQClearIntr(void)
{
#if (CFG_CHIP_FAMILY == 9920)
    ithSetRegBitA(ITH_CMDQ_BASE + ITH_CMDQ_IR1_REG, ITH_CMDQ_INTCLR_BIT);
#else
