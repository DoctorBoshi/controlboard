...
// Definitions
#define ITU_STRINGSET_SIZE          8   ///< Maximum number of strings in ITUStringSet.
 ...
 */
extern void (*ituTransformBlt)(ITUSurface* dest, int dx, int dy, ITUSurface* src, int sx, int sy, int sw, int sh, int x0, int y0, int x1, int y1, int x2, int y2, int x3, int y3, bool bInverse, ITUPageFlowType type);
 ...
 * @return 0 if success. non-zero value if failed.
 */
extern void (*ituFtDrawText)(ITUSurface* surf, int x, int y, const char* text);
...
/**
 * Gotos the specified frame or keyframe of animation widget.
 * If the animation has 2 keyframes only, the frame parameter is mean to frame. Otherwise, it's mean to keyframe.
 *
 * @param animation The playing animation widget to goto.
 * @param frame The specified frame or keyframe of animation widget to goto.
 */
...
typedef struct
{
    ...
    int endAngle;                               ///< The angle of end position. Range from 0-360.
    int pressed;                                ///< Is pressed or not
    int maxValue;                               ///< Current value. Unit is percentage.
...
/**
 * Gotos the specified frame of video widget.
 *
 * @param video The playing video widget to goto.
 * @param frame The specified frame of video widget to goto, in percentage.
 */
...
/**
 * The implemntation of setting pressed the specified widget and it's children.
 *
 * @param widget the widget to set pressed.
 * @param pressed set pressed or not.
 */
 ...
 * @param pressed set pressed or not.
 */
#define ituSetPressedButton(widget, pressed) ituSetPressedButtonImpl((ITUWidget*)(widget), (pressed))
