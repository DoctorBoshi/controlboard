...
#elif defined(CFG_DBG_OSDCONSOLE)
...
#if !defined (CFG_DBG_SWUART_CODEC) && !defined (CFG_SWUART_CODEC_ENABLE) && !defined(CFG_RS485_1_ENABLE)
    iteRiscInit();
#endif
