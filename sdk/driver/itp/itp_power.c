...
static void PowerStandby(void)
{
    ...
    ithSetCpuClockRatio(CFG_POWER_STANDBY_CPU_FREQ_RATIO);
    ithSetBusClockRatio(CFG_POWER_STANDBY_BUS_FREQ_RATIO);
...
//        ITH_PLL1_PD_MASK | ITH_PLL1_UPDATE_MASK);
    ...
    do
    {
        VAL = ITH_GPIO_GET(ITH_IR_BASE + ITH_IR_CAP_STATUS_REG);
