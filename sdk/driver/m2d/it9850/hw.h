...
#define GFX_REG_CR1_RDCRC_UPD               (1 << 29)
#define GFX_REG_CR1_WRCRC_UPD               (1 << 28)
...
#define GFX_REG_CR3_STYLEPERIOD_MASK        0x1F
#define GFX_REG_CR3_STYLEPERIOD_OFFSET      4
#define GFX_REG_CR3_LINESTYLETYPE_MSB       (0 << 9)
#define GFX_REG_CR3_LINESTYLETYPE_LSB       (1 << 9)
#define GFX_REG_CR3_LINEALGORITHM_0         (0 << 3)
#define GFX_REG_CR3_LINEALGORITHM_1         (1 << 3)
#define GFX_REG_CR3_LASTPIXEL_EN            (1 << 2)
#define GFX_REG_CR3_LINESTYLE_EN            (1 << 1)
#define GFX_REG_CR3_RESETSTYLE_EN           (1 << 0)
