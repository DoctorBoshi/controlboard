...
bool ituTrackBarUpdate(ITUWidget* widget, ITUEvent ev, int arg1, int arg2, int arg3)
{
    ...
    if (ev == ITU_EVENT_MOUSEDOWN)
    {
        if (ituWidgetIsEnabled(widget))
        {
            ...
            if (tbar->tip && ituWidgetIsInside(widget, x, y))
...
void ituTrackBarOnAction(ITUWidget* widget, ITUActionType action, char* param)
{
    ...
    case ITU_ACTION_GOTO:
        ituTrackBarSetValue((ITUTrackBar*)widget, atoi(param));
        break;

    case ITU_ACTION_DODELAY0:
        ituExecActions(widget, ((ITUTrackBar*)widget)->actions, ITU_EVENT_DELAY0, atoi(param));
        break;

    case ITU_ACTION_DODELAY1:
        ituExecActions(widget, ((ITUTrackBar*)widget)->actions, ITU_EVENT_DELAY1, atoi(param));
        break;

    case ITU_ACTION_DODELAY2:
        ituExecActions(widget, ((ITUTrackBar*)widget)->actions, ITU_EVENT_DELAY2, atoi(param));
        break;

    case ITU_ACTION_DODELAY3:
        ituExecActions(widget, ((ITUTrackBar*)widget)->actions, ITU_EVENT_DELAY3, atoi(param));
        break;

    case ITU_ACTION_DODELAY4:
        ituExecActions(widget, ((ITUTrackBar*)widget)->actions, ITU_EVENT_DELAY4, atoi(param));
        break;

    case ITU_ACTION_DODELAY5:
        ituExecActions(widget, ((ITUTrackBar*)widget)->actions, ITU_EVENT_DELAY5, atoi(param));
        break;

    case ITU_ACTION_DODELAY6:
        ituExecActions(widget, ((ITUTrackBar*)widget)->actions, ITU_EVENT_DELAY6, atoi(param));
        break;

    case ITU_ACTION_DODELAY7:
        ituExecActions(widget, ((ITUTrackBar*)widget)->actions, ITU_EVENT_DELAY7, atoi(param));
        break;
...
void ituTrackBarSetValue(ITUTrackBar* bar, int value)
{
    ...
    ituExecActions((ITUWidget*)bar, bar->actions, ITU_EVENT_CHANGED, value);
