...
static sem_t                                semConnectStart;
static sem_t                                semConnectStop;
static pthread_mutex_t                      mutexALWiFi;

static sem_t                                semWPSStart;
static sem_t                                semWPSStop;
static pthread_mutex_t                      mutexALWiFiWPS;

static pthread_mutex_t                      mutexIni;
static pthread_mutex_t                      mutexMode;
...
static struct net_device_info               apInfo = {0};
...
retry:
    ...
    //printf("wifi swtich = %d, prepare to auto-connecting...\n", wifi_client_status);
...
WifiMgr_clientMode_switch(int status)
{
	...
	/*if (wifi_client_status == WIFI_IS_TURNED_OPEN){
		printf("###Wifi is turned on. \n");
	}else if(wifi_client_status == WIFI_IS_TURNED_CLOSE){
		printf("###Wifi is turned off. \n");
	}*/
}
