    ...
    if (py_ime_cmp == 'y')
    {
        for (py_i = 0; py_i < sizeofY; py_i++)                     // 16次
        {
            ...
            if (py_ime_cmp == 0)
            {
                ...
                case 1: add  = PY_mb_yan; break;
                case 2: add  = PY_mb_yang; break;
                case 3: add  = PY_mb_yao; break;
                case 4: add  = PY_mb_ye; break;
                case 5: add  = PY_mb_yi; break;
                case 6: add  = PY_mb_yin; break;
                case 7: add  = PY_mb_ying; break;
                case 8: add  = PY_mb_yo; break;
                case 9: add  = PY_mb_yong; break;
                case 10: add = PY_mb_you; break;
                case 11: add = PY_mb_yu; break;
                case 12: add = PY_mb_yuan; break;
                case 13: add = PY_mb_yue; break;
                case 14: add = PY_mb_yun; break;
                }
                g_hanzi_num = (unsigned short)strlen(add); //   拼音  a 的个数
                memcpy(get_hanzi, add, g_hanzi_num);       //  把找到的汉字放在缓冲区
                *hh         = g_hanzi_num / 2;
