...
1._tpReadDevice_vendor()         //read device regiter(*)
2._tpParseRawPxy_vendor()        //parse point rule(*)
...
(*)function 1~4 are neccessary for customized.

	[]INT & PULLING & HIGH/LOW ACTIVE
	[]I2C SLAVE ADDR 0x??
	[]RESOLUTION ???*XXX
	[]rotation & scale & reverse
	[]I2C protocol/register defination
	[]single/multi touch samples
	[]need program to init TP if first power-ON
	[]special rule....
	[]TP's smaple rate(each INTr)
