...
if (DEFINED CFG_I2C0_ENABLE)
    ...
    if (DEFINED CFG_HW_I2C_ENABLE)
        add_definitions(
            -DCFG_HW_I2C_ENABLE
        )

        set(CFG_BUILD_IIC 1)
    elseif (DEFINED CFG_SW_I2C_ENABLE)
        add_definitions(
            -DCFG_SW_I2C_ENABLE
...
if (DEFINED CFG_TOUCH_ENABLE)
    add_definitions(
        -DCFG_TOUCH_ENABLE
        -DCFG_TOUCH_MODULE="${CFG_TOUCH_MODULE}"
    )
...
if (DEFINED CFG_I2S_USE_GPIO_MODE_2)
    add_definitions(
