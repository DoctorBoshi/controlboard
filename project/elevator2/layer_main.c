...
static void MainChangeLayout(void)
{
    ...
    case 0:
        ...
        else
        {
            ...
            ituWidgetSetWidth(mainInfo1Sprite, ituWidgetGetWidth(mainPhoto1Slideshow));
    ...
    case 1:
        if (orient == EXTERNAL_VERTICAL)
        {
            ...
            ituWidgetSetY(mainInfo1Sprite, ituWidgetGetY(mainArrowFloor1Container) - ituWidgetGetHeight(mainInfo1Sprite));
        }
        else
        {
            ...
            ituWidgetSetX(mainInfo1Sprite, 0);
        }
        break;
    ...
    case 2:
        if (orient == EXTERNAL_VERTICAL)
        {
            ...
            ituWidgetSetY(mainInfo1Sprite, mainLayerHeight - ituWidgetGetHeight(mainInfo1Sprite));
        }
        else
        {
            ...
            ituWidgetSetX(mainWeb1Sprite, mainLayerWidth - ituWidgetGetWidth(mainWeb1Sprite));
            ituWidgetSetX(mainInfo1Sprite, ituWidgetGetWidth(mainArrowFloor1Container));
        }
        break;
    ...
    case 3:
        if (orient == EXTERNAL_VERTICAL)
        {
            ituWidgetSetY(mainInfo1Sprite, ituWidgetGetY(mainLogo1Sprite) + ituWidgetGetHeight(mainLogo1Sprite));
        }
        else
        {
            ituWidgetSetY(mainInfo1Sprite, ituWidgetGetY(mainLogo1Sprite) + ituWidgetGetHeight(mainLogo1Sprite));
    ...
    case 4:
        if (orient == EXTERNAL_VERTICAL)
        {
            ituWidgetSetY(mainInfo1Sprite, mainLayerHeight - ituWidgetGetHeight(mainPhoto1Slideshow) / 2 - ituWidgetGetHeight(mainInfo1Sprite) / 2);
        }
        else
        {
            ituWidgetSetY(mainInfo1Sprite, ituWidgetGetHeight(mainPhoto1Slideshow) / 2 - ituWidgetGetHeight(mainInfo1Sprite) / 2);
        }
        break;
...
static MainProcessExternalWarn(ExternalEvent* ev)
{
    ...
    {
        ituWidgetSetVisible(warnSprite, false);
    ...
    {
        ituWidgetSetVisible(warnSprite, true);
        ...
        if (targetFloor == -1)
        {
            ...
            else
            {
                if (ev->arg3 == EXTERNAL_FLOOR_NONE)
                {
                    ...
                    {
                        targetFloor = (ev->arg1 - '0') * 10 + ev->arg2 - '0';
                ...
                else
                {
                    ...
                    {
                        targetFloor = (ev->arg1 - '0') * 100 + (ev->arg2 - '0') * 10 + ev->arg3 - '0';
...
{
	if (theConfig.sound_enable && playState == PLAY_NONE && ituWidgetIsVisible(mainMusicMediaFileListBox) && !mainVideo->playing)
    {
    ...
    if (!activeMainInfo1Animation && ituWidgetIsVisible(mainInfo1Sprite) && ituWidgetIsVisible(mainInfo1TextMediaFileListBox) && ituWidgetIsVisible(mainInfo1FontMediaFileListBox))
    {
    ...
    if (!activeMainInfo2Animation && ituWidgetIsVisible(mainInfo2Sprite) && ituWidgetIsVisible(mainInfo2TextMediaFileListBox) && ituWidgetIsVisible(mainInfo2FontMediaFileListBox))
    {
...
bool MainOnEnter(ITUWidget* widget, char* param)
{
    if (!mainLayer)
    {
        ...
        ituWidgetSetVisible(warn1Sprite, false);
