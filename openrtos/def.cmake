...
if (DEFINED CFG_CPU_FA626)
    ...
    set(CMAKE_EXE_LINKER_FLAGS          "${EXTRA_FLAGS} -mcpu=fa626te ${MAP_FLAGS} -nostartfiles -T\"${LIBRARY_OUTPUT_PATH}/default.ld\" -L\"${LIBRARY_OUTPUT_PATH}\" \"${LIBRARY_OUTPUT_PATH}/startup.o\"")
